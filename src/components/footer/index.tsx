    ...
    return (
        <footer className="w-full bg-white shadow-2xl dark:bg-gray-900 ">
            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                ...
                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <Link to={"/"} className="hover:underline">Rwa Suplementos</Link>. Todos os direitos reservados.</span>
            </div>
        </footer>
    )
}