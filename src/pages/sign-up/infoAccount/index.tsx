...
export function InfoAccount() {
    ...
    return (
            <div className="flex flex-col justify-center mx-auto items-center mt-10 mb-10">
                ...
                <Stack spacing={4} className="w-full max-w-full lg:px-12 mt-10">
                    ...
                    <form onSubmit={(e) => verifySectionInfo(e)} className="flex flex-col gap-7 w-full max-w-6xl mt-16 px-10">
                        { 
                            step == 0 ?  (
                                <section className="grid grid-cols-1 md:grid-cols-2 gap-7">
                                    <div className='w-full text-sm text-gray-600 relative'>
                                        ...
                                        <Input  value={name} onChange={(e) => setName(e.target.value)} placeholder='Digite seu nome completo' type='text' id='user' className='text-xs mt-2' required/>
                                                           ...
                                                           
                                       {
                                            <section className={`grid grid-cols-1 md:grid-cols-2 gap-7 ${cep.length != 8 ? "opacity-70" : "" }`}>
                                                <div className='w-full text-sm text-gray-600 relative'>
                                                    ...
                                                    <Input value={street} onChange={(e) => setStreet(e.target.value)} placeholder='Digite o name da sua rua' type='text' id='rua' readOnly={cep.length != 8} className={`text-xs mt-2 ${cep.length != 8 ? " opacity-80 cursor-not-allowed bg-gray-200" : ""}`} required/>
                                                ...
                                                <div className='w-full text-sm text-gray-600 relative'>
                                                    ...
                                                    <Input value={neighborhood} onChange={(e) => setNeighborhood(e.target.value)} placeholder='Digite o name do bairro' type='text' id='bairro' readOnly={cep.length != 8} className={`text-xs mt-2 ${cep.length != 8 ? " opacity-80 cursor-not-allowed bg-gray-200" : ""}`} required/>
                                                ...
                                                <div className={"w-full text-sm text-gray-600 relative"}>
                                                    ...
                                                    <Input value={city} onChange={(e) => setCity(e.target.value)} placeholder='Digite o name da cidade' type='text' id='cidade'  readOnly={cep.length != 8} className={`text-xs mt-2 ${cep.length != 8 ? " cursor-not-allowed bg-gray-200" : ""}`} required/>
                                                    <GiModernCity fontSize={18} className="absolute top-10 right-3 "/>
                                                </div>

                                                <div className='w-full text-sm text-gray-600 relative'>
                                                    <label htmlFor="estado" className='ml-1'>Estado *</label>
                                                    <Input value={state} onChange={(e) => setState(e.target.value)} placeholder='Digite o name do estado' type='text' id='estado'  readOnly={cep.length != 8} className={`text-xs mt-2 ${cep.length != 8 ? "  cursor-not-allowed bg-gray-200" : ""}`} required/>
